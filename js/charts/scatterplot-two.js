...
class ScatterplotTwo {
    ...
    initVis() {
        ...
        vis.svg = d3.select(vis.config.parentElement).append('svg')
            ...
            .attr('style', 'background-color:rgba(190, 190, 190, 0.65)');
    ...
    updateVis() {
        ...
        const currentCategory = vis.topThreeCategories[INDEX_1]
        if (!currentCategory) {
    ...
    renderVis() {
        ...
        const category = vis.topThreeCategories[INDEX_1]
        ...
        const circles = vis.chart.selectAll('.point-two')
            .data(circlesData, d => d.college_name)
            .join('circle')
            .attr('class', 'point-two')
            .attr('r', 2)
        ...
        vis.chart.selectAll('.most-correlated')
            ...
            .join(
                enter => enter.append("text")
                    ...
                    .text(categoryNameAndDescription.get(vis.topThreeCategories[INDEX_1])[0]),
                update => update.text(categoryNameAndDescription.get(vis.topThreeCategories[INDEX_1])[0])
            )
        ...
        vis.dispatcher.call('completedInitialLoad', null, `scatterplot ${INDEX_1}`);
    }
}
