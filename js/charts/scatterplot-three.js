...
class ScatterplotThree {
    ...
    initVis() {
        ...
        vis.svg = d3.select(vis.config.parentElement).append('svg')
            ...
            .attr('style', 'background-color:rgba(207, 128, 10, 0.6)');
    ...
    renderVis() {
        ...
        const circles = vis.chart.selectAll('.point-three')
            .data(circlesData, d => d.college_name)
            .join('circle')
            .attr('class', 'point-three')
            .attr('r', 2)
        ...
        vis.yAxisG
            ...
            .join(
                enter => enter.append("text")
                    ...
                    .text(categoryNameAndDescription.get(vis.topThreeCategories[INDEX_2])[0]),
                update => update.text(categoryNameAndDescription.get(vis.topThreeCategories[INDEX_2])[0])
            )
